...
void SKYBOX_DrawSkyBox( float camera_yaw, float camera_pitch ){
	// Cube size
	float t = 1.5f;
...
void SKYBOX_Render( float camera_yaw, float camera_pitch ){
	...
	SKYBOX_DrawSkyBox( camera_yaw, camera_pitch );
